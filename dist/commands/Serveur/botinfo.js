...
export default {
    ...
    run: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const infoEmbed = new EmbedBuilder()
            .setTitle('Informations Système du Bot')
            .addFields({ name: "🖥️ Système d'exploitation", value: `${os.type()} ${os.version()} ${os.release()} ${arch} bits`, inline: true }, 
        //{ name: '🖥️ Architecture', value: arch, inline: true },
        { name: '⚡ CPU', value: cpuModel, inline: true }, { name: '💾 Mémoire', value: `Total: ${ramSize}\nLibre: ${freeRamSize}`, inline: true }, { name: '⏲️ Uptime', value: `${Math.floor(uptime / 3600)} heures ${Math.floor((uptime % 3600) / 60)} minutes ${Math.floor(uptime % 60)} secondes`, inline: true }, { name: "📂 Version de node.js", value: `${process.version}`, inline: true }, { name: "📂 Version de discord.js", value: `${version}`, inline: true }, { name: '🍆 Taille du sexe', value: `${totalOnlineUsers} centimètres`, inline: true })
            .setColor('#00FDCC')
            .setTimestamp()
            .setFooter({ text: `Demandé par ${interaction.user.tag}`, iconURL: `${interaction.user.displayAvatarURL()}` });
        // Répondre avec l'embed
