...
export default {
    YOU_HAVE_BEEN_BANNED: function (interaction) {
    ...
    */
    UNKNOWN_ERROR: function (interaction, error) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    INVALID_INTERACTION: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    INVALID_ARGUMENT: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    COOLDOWN_ACTIVATED: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    PLEASE_JOIN_SAME_VOICE_CHANNEL: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    CAN_NOT_JOIN_VOICE_CHANNEL: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    MUSIC_QUEUE_IS_EMPTY: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    MUSIC_IS_PLAYING: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    CAN_NOT_FIND_MUSIC: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    CAN_NOT_FIND_PREVIOUS_MUSIC: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    MUSIC_IS_TOO_LONG: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    CAN_NOT_USE_IN_DM: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    GAME_IS_NOT_STARTED: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
    ...
    GAME_IS_ALREADY_STARTED: function (interaction) {
        const embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setTitle("❌ Erreur!")
